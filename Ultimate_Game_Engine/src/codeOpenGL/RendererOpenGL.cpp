...
Ultimate::RendererOpenGL::RendererOpenGL() {
    ...
    mShaderPtr = std::unique_ptr<Shader>{new Shader{"/Users/soleilrosado/CLionProjects/S24_Prasanga_Tiwari/Ultimate_Game_Engine/Assets/Shaders/DefaultVertexShader.glsl", "/Users/soleilrosado/CLionProjects/S24_Prasanga_Tiwari/Ultimate_Game_Engine/Assets/Shaders/DefaultFragmentShader.glsl"}};
    /// Blending ///
    glEnable(GL_BLEND);
